// src/app/services/branding/BrandingLogoDesigningPage.tsx

"use client";

import { motion, type Variants } from "framer-motion";
import { ChevronRight, Cloud } from "lucide-react";
import { scope, quality, deliverables, process, tech } from "./branding.data";
    ...
    <section className="text-gray-800">
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-cyan-50">
        ...
        <div className="max-w-7xl mx-auto px-6 py-20 text-center">
          ...
          >
            From strategy to identity to market-ready creative. We craft a brand that looks sharp,
            speaks clearly, and performs across ads, web, social and campaigns.
          </motion.p>
          <motion.div
            variants={fadeUp}
            initial="hidden"
      ...
      <div className="pb-16">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <h3 className="text-2xl md:text-3xl font-extrabold">Ready to launch a brand people remember?</h3>
            <p className="mt-2 opacity-90">We’ll craft the identity and the campaign kit to take it to market.</p>
            <a
              href="/contact"
              className="mt-6 inline-flex items-center rounded-full bg-gradient-to-r from-blue-600 to-cyan-500 hover:opacity-90 px-6 py-3 text-sm font-semibold text-white shadow-sm transition"
            >
              Talk to the team
            </a>
          </motion.div>
