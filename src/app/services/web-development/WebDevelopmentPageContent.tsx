// src/app/services/web-development/WebDevelopmentPageContent.tsx
...
import { scope, quality, deliverables, process, tech } from "./web-development.data";
...
export default function WebDevelopmentPageContent() {
  return (
    <section className="text-gray-800">
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-cyan-50">
        ...
        <div className="max-w-7xl mx-auto px-6 py-20 text-center">
          ...
          >
            Fast, secure, SEO-ready websites and apps. Clear UX, robust engineering, reliable delivery.
          </motion.p>
          <motion.div
            variants={fadeUp}
            initial="hidden"
        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          ...
          >
            <a
              ...
              className="inline-flex items-center rounded-full bg-gradient-to-r from-blue-600 to-cyan-500 px-6 py-3 text-sm font-semibold text-white hover:opacity-90 transition"
            >
              Explore QA Services
            </a>
          </motion.div>
      ...
      <div className="pb-16">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <h3 className="text-2xl md:text-3xl font-extrabold">Ready to build something great?</h3>
            <p className="mt-2 opacity-90">Tell us your goals — we’ll map the fastest path to value.</p>
            <a
              href="/contact"
