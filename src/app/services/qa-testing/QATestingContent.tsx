// src/app/services/qa-testing/QATestingContent.tsx

"use client";

import { motion, type Variants } from "framer-motion";
import { Cloud, ChevronRight } from "lucide-react";
import { scope, quality, deliverables, process, tech } from "./qa-testing.data";
...
export default function QATestingContent() {
  return (
    <section className="text-gray-800">
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-cyan-50">
        ...
        <div className="max-w-7xl mx-auto px-6 py-20 text-center">
          ...
          >
            Manual and automated testing for reliability, speed, security, and accessibility—built into your delivery pipeline.
          </motion.p>
          <motion.div
            variants={fadeUp}
            initial="hidden"
      ...
      <div className="bg-gradient-to-br from-blue-50 via-white to-cyan-50">
        <div className="max-w-7xl mx-auto px-6 py-16">
          ...
          {/* Optional cross-link: explore Web or App QA entry points */}
          <motion.div
            variants={fadeUp}
            initial="hidden"
            whileInView="show"
      ...
      <div className="pb-16">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <h3 className="text-2xl md:text-3xl font-extrabold">Ready to raise your product quality?</h3>
            <p className="mt-2 opacity-90">Tell us your goals — we’ll map the fastest path to reliable releases.</p>
            <a
              href="/contact"
