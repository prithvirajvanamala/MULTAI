// src/app/services/ui-ux-design/UIUXDesignPage.tsx

"use client";

import { motion, type Variants } from "framer-motion";
import { ChevronRight, Cloud } from "lucide-react";
import { scope, quality, deliverables, process, tech } from "./ui-ux-design.data";
    ...
    <section className="text-gray-800">
      ...
      <div className="pb-16">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <h3 className="text-2xl md:text-3xl font-extrabold">Ready to craft a standout experience?</h3>
            <p className="mt-2 opacity-90">Tell us your goals — we’ll design and validate the fastest path to impact.</p>
            <a
              href="/contact"
